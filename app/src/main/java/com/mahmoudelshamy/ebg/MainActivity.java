...
public class MainActivity extends BaseActivity implements WheelView.OnWheelItemClickListener, View.OnClickListener {
    ...
    private void initComponents() {
        // customize actionbar
        setActionBarTitle(R.string.egypt_business_guide);
    ...
    public void onWheelItemClick(WheelView parent, int position, boolean isSelected) {
        ...
        switch (position) {
            case 0:
                intent = new Intent(this, EMCActivity.class);
                break;

            case 1:
                intent = new Intent(this, TradeRoomActivity.class);
                break;
    ...
    public List<WheelItem> getMenuItems() {
        ...
        WheelItem wheelItem0 = new WheelItem(getString(R.string.egypt_media_center), getResources().getDrawable(R.drawable.radial_menu_icon));
        wheelItems.add(wheelItem0);

        WheelItem wheelItem1 = new WheelItem(getString(R.string.trade_room), getResources().getDrawable(R.drawable.radial_menu_icon));
        wheelItems.add(wheelItem1);

        WheelItem wheelItem2 = new WheelItem(getString(R.string.investment_in_egypt), getResources().getDrawable(R.drawable.radial_menu_icon));
